...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Text(
            'İstatistikleriniz:\n\n'
            'Toplam Oyun: ${data['statistics']['totalGames']}\n'
            'Galibiyet: ${data['statistics']['wins']}\n'
            'Mağlubiyet: ${data['statistics']['losses']}\n'
            'Beraberlik: ${data['statistics']['draws']}\n'
            'Mevcut Seri: ${data['statistics']['currentStreak']}\n'
            'En Uzun Seri: ${data['statistics']['longestStreak']}\n'
            'Kazanma Oranı: ${data['statistics']['winRate']}\n'
            'Favori Seçim: ${data['statistics']['favoriteChoice']}\n\n'
            'Tema: ${data['themeMode']}\n'
            'Sesler: ${data['soundEnabled'] ? 'Açık' : 'Kapalı'}\n'
            'Titreşim: ${data['hapticsEnabled'] ? 'Açık' : 'Kapalı'}\n'
            'Varsayılan Tur: ${data['defaultRounds']}'
          ),
        ),
        actions: [
          TextButton(
  ...
  void _openContact() async {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('E-posta istemcisi açılamadı')),
      );
    }
  }
}
